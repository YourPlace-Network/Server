...
will need to understand this layout to be able to speak to the network.
...
- `yp/1/pa:{"p":"payload","a":[["ipfs://CID/path.exe","application/vnd.microsoft.portable-executable",4096, base64filename],["ipfs://CID2/path2.jpg","image/jpeg",2048, base64filename]]}` - Post a message with file attachment(s) [{path, mimetype, size}]
