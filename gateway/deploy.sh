...
docker run -d --name yourplace-gateway --restart unless-stopped --log-driver awslogs --log-opt awslogs-region=AWS_REGION_PLACEHOLDER --log-opt awslogs-group=/ec2/yourplace-gateway -p 443:443 -v /opt/YourPlace:/opt/YourPlace -e BASE_RPC_THROTTLE='BASE_RPC_THROTTLE_PLACEHOLDER' -e BASE_RPC_URL='BASE_RPC_URL_PLACEHOLDER' -e PINATA_NFT_GROUP='PINATA_NFT_GROUP_PLACEHOLDER' -e YOURPLACE_IPFS_PINNING_KEY='PINNING_KEY_PLACEHOLDER' -e YOURPLACE_IPFS_PINNING_TYPE='PINNING_TYPE_PLACEHOLDER' -e YOURPLACE_IPFS_PINNING_URL='PINNING_URL_PLACEHOLDER' -e YOURPLACE_ORIGIN='YOURPLACE_ORIGIN_PLACEHOLDER' $MYSQL_DSN_ENV ECR_REGISTRY_PLACEHOLDER/yourplace-gateway:latest
...
SCRIPT="${SCRIPT//PINATA_NFT_GROUP_PLACEHOLDER/$PINATA_NFT_GROUP}"
